city(1).name = 'Pensacola'; city(1).coords = [30.43 -87.2]; 
city(1).pop= 437125; %metro area
...
city(5).name = 'Ocala'; city(5).coords = [29.19 -82.13]; 
city(5).pop =316183; %metro area
...
city(9).name = 'Orlando'; city(9).coords = [28.53 -81.38]; 
city(9).pop= 2633282; %metro area (Orlando-Kissimee)
...
city(13).name = 'Tampa'; city(13).coords = [27.97 -82.46]; 
city(13).pop= 2.7e6/2; 
%three-city metro area (Tampa-StPetersburg-Clearwater)
...
city(19).name = 'Naples';city(19).coords = [26.15 -81.80]; 
city(19).pop= 314649; %metro area
city(20).name = 'Ft Lauderdale'; city(20).coords = [26.14 -80.14];
city(20).pop = 5463857/3; %three-city metro area (South Florida)
city(21).name = 'Miami'; city(21).coords = [25.79 -80.22]; 
city(21).pop= 5463857/3;%three-city metro area (South Florida)
